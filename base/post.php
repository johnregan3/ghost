...
<article class="entry post">
	<div class="inner">
		<header class="entry-header">
			...
			<div class="entry-meta">Published 14 July 2014</div>
		...
		<!-- Sample Content to Plugin to Template -->
			...
			<fieldset>
				...
				<form>
					...
					<p><input class="btn btn-default" type="reset" value="Clear" /> <input class="btn btn-default" type="submit" value="Submit" /> <button class="btn btn-default">Button</button>
					</p>
